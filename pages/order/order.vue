            ...
            <view class="order-list">
              ...
              >
                <view class="header">
                  ...
                  <view class="status">
                    <view
                      v-if="order.payment_state == 0"
                      @click="jump_detail(order.order_id)"
                    >
                      未支付
                    </view>
                ...
                <view class="action">
                  <view
                    v-if="order.payment_state == 0"
                    @tap="pay(order.order_id, order.payment_state)"
                    class="button button_pay"
                    hover-class="none"
                    >去支付</view
                  >
                  <view
                    v-if="order.payment_state == 0"
                    @tap="deleteOrder(order.order_id)"
                  ...
                  <view
                    v-else-if="order.state != 0 && order.payment_state == 1"
                    @tap="ckpl(order.order_id)"
                    class="button"
                    hover-class="none"
                    >去评论</view
                  >
