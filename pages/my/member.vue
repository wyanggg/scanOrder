<template>
  <view class="container">
    <view class="header">
      <image
        src="https://static.heytea.com/weapp/images/member/me_kaitong_img_card.png"
        class="card-img"
        mode="widthFix"
      ></image>
    ...
    <view class="footer">
      ...
      <view class="bottom">
        <view class="font-size-lg font-weight-bold ml-30"> 总价：<text class="text-color-primary">179/12月</text> </view>
